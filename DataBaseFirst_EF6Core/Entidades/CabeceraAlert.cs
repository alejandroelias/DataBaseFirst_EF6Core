...
{
    public partial class CabeceraAlert
    {
        public string NombreReceptorSujetoExcluido { get; set; } = null!;
        public string? FechaHoraCorreo { get; set; }
        public string? ConexionEmail { get; set; }
        public string? ConexionEmailPass { get; set; }
        public string? ConexionEmailTitle { get; set; }
        public string? ConexionEmailAsunto { get; set; }
        public string? ConexionEmailCuerpo { get; set; }
        public string? ConexionEmailIp { get; set; }
        public int? ConexionEmailPuerto { get; set; }
        public string CeroComaCero { get; set; } = null!;
        public string VaCio { get; set; } = null!;
        public string Qr { get; set; } = null!;
        public string QrCorreo { get; set; } = null!;
        public string? IdentificacionModeloFacturacion { get; set; }
        public string? IdentificacionTipoTransmision { get; set; }
        public string? EmpresaNombrePdf { get; set; }
        public string? EmisorNrcPdf { get; set; }
        public string? EmisorLogoPdf { get; set; }
        public string? FaceBookPdf { get; set; }
        public string? InstagramPdf { get; set; }
        public string? CorreoPdf { get; set; }
        public string? WhatsAppPdf { get; set; }
        public string EmisorDireccionPdf { get; set; } = null!;
        public string SujetoExcluidoDireccionPdf { get; set; } = null!;
        public string? EmisorTipoEstablecimientoPdf { get; set; }
        public string? IdentificacionTipoDocumento { get; set; }
        public string ReceptorDireccionPdf { get; set; } = null!;
        public string? ReceptorTipoDocumentoPdf { get; set; }
        public string? SujetoExcludioTipoDocumentoPdf { get; set; }
        public string? ResumenCondicionOperacionPdf { get; set; }
        public string? EmisorNitPdf { get; set; }
        ...
        public string? IdentificacionNumeroControl { get; set; }
